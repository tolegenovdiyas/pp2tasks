...
minutes_hand_image = pygame.image.load("right-hand.png")
seconds_hand_image = pygame.image.load("left-hand.png")

minutes_hand_image = pygame.transform.scale(minutes_hand_image, (250, 100))
seconds_hand_image = pygame.transform.scale(seconds_hand_image, (250, 100))
